<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="NextGen_Application_Bookauthor_ForntEnd.Account.OpenAuthProviders" %>
